...
class GnnLoader(DataBase):
    ...
    def __init__(self, args):
        ...
        print(f"Reverse Adjacent List :{self.adj_r_list}")
        """
        #printing sparse matrix from the first element of adj_list
        print(adj_list[0].todense())
        plt.spy(adj_list[0])
        plt.show()
        return 0
        """
    ...
    def _get_relational_adj_list(self) -> tuple:
        ...
        print(f"Adj_mat_list : {adj_mat_list}")
        print(f"adj_r_list : {adj_r_list}")
