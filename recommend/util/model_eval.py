...
def validation(sess: tf.compat.v1.Session(), model: GNN, data_generator: GnnLoader, threshold: float) -> dict:
...
def test(sess: tf.compat.v1.Session(), model: GNN, data_generator: GnnLoader, threshold: float) -> dict:
...
def pred_inter(sess: tf.compat.v1.Session(), model: GNN, inters: list) -> np.ndarray:
